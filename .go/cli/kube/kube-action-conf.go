...
func execKubeActionConf(namespace string, appName string, ymls []string) {
	var (
		wg         sync.WaitGroup
		...
		isHaveSA       = fm.IfHaveIn("sa", ymls...)
		isHaveCM       = fm.IfHaveIn("cm", ymls...)
		isHaveSecret   = fm.IfHaveIn("secret", ymls...)
		isHaveDep      = fm.IfHaveIn("dep", ymls...)
		isHavePDB      = fm.IfHaveIn("pdb", ymls...)
		isHaveHPA      = fm.IfHaveIn("hpa", ymls...)
		isHaveSVC      = fm.IfHaveIn("svc", ymls...)
		isHaveING      = fm.IfHaveIn("ing", ymls...)
		isHaveStateful = fm.IfHaveIn("stateful", ymls...)
		isHavePV       = fm.IfHaveIn("pv", ymls...)
		isHavePVC      = fm.IfHaveIn("pvc", ymls...)
